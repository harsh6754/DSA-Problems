...
//      static vector<string> existingUsernames;
...
//     //             userName.clear(); // Clear the entered username
//     //             return;
//     //         }
...
//     //     } else {
//     //         cout << "You are already signed up. Please log in or choose a different option." << endl;
//     //     }
//     // }
//     void signUp() {
//         if (userName.empty()) {
...
//             existingUsernames.push_back(userName);  // Add the new username to the list.
...
// private:
//     bool userExists(const string& enteredUserName) {
//         // In a real-world scenario, you might check against a database.
//         // For simplicity, I'm using a static comparison.
//         return enteredUserName == userName;
//     }
...
private:
    ...
    static vector<string> existingUsernames; // Static vector to store existing usernames.
...
private:
    bool userExists(const string &enteredUserName)
    {
        for (const string &existingUsername : existingUsernames)
        {
            if (existingUsername == enteredUserName)
            {
                return true;
            }
        }
...
vector<string> AtmCard::existingUsernames;
